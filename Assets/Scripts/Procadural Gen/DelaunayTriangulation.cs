...
public class DelaunayTriangulation : MonoBehaviour
{
    ...
    public class Edge
    {
        ...
        {
            return DelaunayTriangulation.AlmostEqual(left.X, right.X) && DelaunayTriangulation.AlmostEqual(left.Y, right.Y)
                || DelaunayTriangulation.AlmostEqual(left.X, right.Y) && DelaunayTriangulation.AlmostEqual(left.Y, right.X);
        }
    }
